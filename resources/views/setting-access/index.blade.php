                ...
                @foreach($dashCols as $c)
                    ...
                    >
                        <input
                            ...
                            name="dash[{{ $c->Field }}]"
                            {{ !empty($dashData->{$c->Field} ?? null) ? 'checked' : '' }}
                        >

                        <span class="text-sm font-medium">
                            {{ strtoupper(str_replace('_',' ',$c->Field)) }}
                        </span>
                    </label>
                @endforeach
            </div>
                ...
                @foreach($menuCols as $c)
                    ...
                    >
                        <input
                            ...
                            class="hidden access-checkbox"
                            name="menu[{{ $c->Field }}]"
                            {{ !empty($menuData->{$c->Field} ?? null) ? 'checked' : '' }}
                        >
